function init() {
    ...
    var graygrad = $(go.Brush, go.Brush.Linear,
    ...
    function commonLinkingToolInit(tool) {
        ...
        // change the standard proposed ports feedback from magenta rectangles to transparent circles
    ...
    myDiagram.addDiagramListener("LayoutCompleted", function(e) {
        ...
        while (it.next()) {
            var node = it.value;
            if (node.category === "Recycle") continue;
